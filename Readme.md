...
* Higher accuracy when each recipe was a "document", full ingredients were used rather than ingredient words, cleaned for accents, separated for words, lowercased, common/meaningless modifiers removed, hypens/parentheticals removed, low alpha in NB model, using MultinomialNB versus BernoulliNB, no smooth_idf for TFID transformer
